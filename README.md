...
`To authenticate Firebase, you can use this project [spring-boot-starter-firebase-user-authentication](https://github.com/alperkurtul/spring-boot-starter-firebase-user-authentication/).`
